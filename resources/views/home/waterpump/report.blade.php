...
@section('title', 'SYNHO | Reporte Tanque de agua')
                            ...
                            <form id="report-viatic" action="#" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-secondary oculto" id="whatsapp_data">
                                            <i class="fas fa-mail-bulk"></i> whatsapp
                                        </button>
                                    </div>
                                </div>
                            </form>
...
@section('js')
    <script src="{{ asset('js/waterpump/report.js') }}"></script>
@stop
